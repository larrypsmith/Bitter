...
Checkin.delete_all
Checkin.create!(user_id: demo_user.id, beer_id: ipa.id, rating: 4, body: "A classic. My default beer when I can't make up my mind at a bar")
Checkin.create!(user_id: demo_user.id, beer_id: pliny_the_elder.id, rating: 4, body: "Refreshing and strong. I see why the hype is so strong. Truly exceptional")
Checkin.create!(user_id: demo_user.id, beer_id: anchor_steam.id, rating: 3, body: "Just alright. There are much better beers from SF-based breweries")
Checkin.create!(user_id: beer_lover12.id, beer_id: pliny_the_younger.id, rating: 5, body: "Can't believe I got a chance to try it. Even better than 'Elder.'")
Checkin.create!(user_id: beer_lover12.id, beer_id: liberty_ale.id, rating: 2, body: "Disappointed in this brew. Was expecting a more traditional American ale.")
Checkin.create!(user_id: bay_area_beer_luvr.id, beer_id: pliny_the_younger.id, rating: 4, body: "A very good beer, but not sure what all the hype is about.")
Checkin.create!(user_id: bay_area_beer_luvr.id, beer_id: liberty_ale.id, rating: 1, body: "Bland, boring, uneventful. I'd rather drink White Claw.")
Checkin.create!(user_id: bay_area_beer_luvr.id, beer_id: a_little_sumpin_sumpin_ale.id, rating: 3, body: "Great when fresh and in a glass. Can't stand to drink it out of a bottle.")
Checkin.create!(user_id: i_love_beer.id, beer_id: a_little_sumpin_sumpin_ale.id, rating: 4, body: "My go-to beer. Got six 12-packs in my fridge.")
...
Checkin.create!(user_id: beer_lover12.id, beer_id: villager.id, rating: 3, body: "Nice hints of citrus, but alltogether unimpressive.")
Checkin.create!(user_id: the_beer_snob.id, beer_id: racer_5.id, rating: 4, body: "The only beer I like from Bear Republic. Gives Lagunitas IPA a run for its money.")
Checkin.create!(user_id: the_beer_snob.id, beer_id: anchor_steam.id, rating: 4, body: "Had to try it because it's my dad's favorite beer. Now I understand why!")
Checkin.create!(user_id: the_beer_snob.id, beer_id: a_little_sumpin_sumpin_ale.id, rating: 4, body: "Tastes like an IPA, which caught me off guard. But delicious nonetheless")
Checkin.create!(user_id: cider_rules.id, beer_id: pliny_the_elder.id, rating: 5, body: "My all-time favorite beer. So glad they started making larger batches. Tons of places have it in stock now.")
Checkin.create!(user_id: cider_rules.id, beer_id: ksa.id, rating: 2, body: "Didn't want an IPA so I went with this. Instantly regretted my decision.")
Checkin.create!(user_id: cider_rules.id, beer_id: villager.id, rating: 2, body: "I don't know why I try anything other than cider.")
...
Checkin.create!(user_id: i_love_beer.id, beer_id: ipa.id, rating: 2, body: "Not too hoppy or malty. Not much of a flavor profile at all. Just whatever.")
Checkin.create!(user_id: i_love_beer.id, beer_id: ksa.id, rating: 4, body: "my favorite beer when I'm not feeling an IPA.")
Checkin.create!(user_id: warriors_fan22.id, beer_id: villager.id, rating: 4, body: "Love the citrus notes on this beer. A bit expensive compared to similar hazy IPAs.")
Checkin.create!(user_id: warriors_fan22.id, beer_id: anchor_steam.id, rating: 3, body: "Hearty and flavorful without being overbearing. Not amazing, but decent.")
Checkin.create!(user_id: warriors_fan22.id, beer_id: a_little_sumpin_sumpin_ale.id, rating: 3, body: "I prefer their IPA more, but this is a good occasional alternative")
Checkin.create!(user_id: lagunitas_or_die.id, beer_id: pliny_the_younger.id, rating: 5, body: "Waited in line for 4 hours to try this. Totally worth it.")
...
Checkin.create!(user_id: lagunitas_or_die.id, beer_id: pliny_the_elder.id, rating: 4, body: "90% as good as 'Younger' and much easier to find now.")
Checkin.create!(user_id: lagunitas_or_die.id, beer_id: racer_5.id, rating: 4, body: "Strong traditional IPA. No fruity notes to speak of. The only beer I've tried from Bear Repulic.")
Checkin.create!(user_id: the_home_brewer.id, beer_id: racer_5.id, rating: 2, body: "Too bitter and strong for my taste. Feeling tired after a single pint.")
Checkin.create!(user_id: the_home_brewer.id, beer_id: ipa.id, rating: 2, body: "Not as good as everyone makes it out to be. My home-brewed IPA is far superior!")
